...
const DisplayPatients = ({ currentPatients, patientRecords, handleEditPatient, handleDeletePatient, idxNumber }) => {
      ...
      <tbody>
        {
          currentPatients.map((p, index) => (
            <ReadableRecord key={p._id} p={p} index={index} idxNumber={idxNumber} handleEditId={handleEditId} handleDeleteId={handleDeleteId}/>
          ))
        }
      </tbody>
